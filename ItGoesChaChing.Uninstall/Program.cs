...
using ItGoesChaChing.Uninstall.Properties;

namespace ItGoesChaChing.Uninstall
{
	static class Program
	{
		...
		static void Main()
		{
			try
			{
				...
				DialogResult result = MessageBox.Show(Resources.Uninstall_Question, Resources.Uninstall + Globals.ProductName, MessageBoxButtons.YesNo);
